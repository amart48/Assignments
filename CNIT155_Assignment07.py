...
def main():
    ...
    while flag == True:
        ...
        if user_input == 1:
            ...
            print(f"The greatest number among the three numbers: {int(maxResult)}")

        elif user_input == 3:
            print("\n3. Find the number of digits")
            N = input("Enter a natural number for N: ")
            numberResult = digits(N)
            print(f"The number of digits in {N} is {numberResult}")
